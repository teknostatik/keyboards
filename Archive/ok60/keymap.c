...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL, MO(1), KC_LALT,               KC_SPC,                       KC_RALT, MT(MOD_LCTL, KC_F5),   KC_RGUI,  MO(1)
    ),
    ...
    [1] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, BL_DOWN, BL_TOGG, BL_UP,   KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______, _______,
