...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_iso_split_rshift(
        ...
        KC_LSFT, KC_GRAVE, KC_Z,    KC_X,    KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT,KC_ENT),MO(1),
        KC_LCTL, MO(1), KC_LALT,               KC_SPC,                        MT(MOD_LALT,KC_LEFT), MT(MOD_LGUI,KC_DOWN), KC_UP, MT(MOD_RCTL,KC_RGHT)
    ),
