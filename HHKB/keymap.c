...
[0] = LAYOUT_60_hhkb( /* Base */
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                KC_SPC,                            KC_RALT,  CTL_T(KC_LCTL),          KC_RCTL          ),
...
[1] = LAYOUT_60_hhkb( /* FN */
    ...
    KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,  KC_PGUP, KC_LEFT,  KC_RGHT,            KC_TRNS,
    KC_TRNS,          KC_TRNS, S1_DEC,  S1_INC,  KC_HOME,  KC_PGDN,  KC_PGUP, KC_END,  KC_END,  KC_PGDN,  KC_DOWN,  KC_TRNS,           KC_TRNS,
