...
[0] = LAYOUT_60_hhkb( /* Base */
    ...
    KC_LSFT,            KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_LALT,
    KC_LCTL,  MO(1),  KC_LALT,                KC_SPC,                            MT(MOD_LGUI, KC_F5), MT(MOD_LCTL, KC_F5),  KC_RCTL          ),
